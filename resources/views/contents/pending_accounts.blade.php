...
<script type="text/javascript">
    ...
    function show_tableRows(){
        ...
        data.forEach(arr => {
            ...
            el+='<button id="accept_user" class="btn btn-success btn-sm btn-view"><i class="fas fa-check-circle"></i></button>';
            el+='</td>';
    ...
    $('#dataTable').on('click', '#accept_user', function(){
        let tr = $(this).closest('tr');
        let i = tr.data('index');
        ConfirmationModal('#confirmation_modal', {
            data: {
