...
<style>
    ...
    <main>
        <div class="container-fluid">
            <h1 class="mt-4">Completed Research</h1>
            <ol class="breadcrumb mb-4">
				<li class="breadcrumb-item active"><i></i></li>
            </ol>
            <div class="card mb-4">
                <div class="card-header"><i class="fas fa-table mr-1"></i>List of All Completed Research</div>
                <div class="card-body">
...
<script type="text/javascript">
    ...
    function init(){
        ...
        console.log(data);
        const owner = {{@$owner}};
        let completed = new Research('completed', {
            data: data,
            owner: owner,
            view: view,
            cols: viewCols[view],
        ...
        completed.show_tableHead(viewTh[view]);
        completed.show_tableRows();
        completed.init_datatable();
    }
