...
<script type="text/javascript">
    ...
    function show_tableRows(){
        ...
        data.forEach(arr => {
            ...
            if(arr.unit_id){
                ...
                el+='<td style="text-align:center;">N/A</td>';
            }
            ...
            el+='<button id="disable_user" class="btn btn-warning btn-sm btn-view"><i class="fas fa-user-slash"></i></button>';
            el+='</td>';
    ...
    $('#dataTable').on('click', '#disable_user', function(){
        let tr = $(this).closest('tr');
        let i = tr.data('index');
        ConfirmationModal('#confirmation_modal', {
            data: {
